...
namespace Hangfire.Raven.Storage {
    ...
    {
        public static void AddExpire<T>(this IAsyncAdvancedSessionOperations advanced, T obj, DateTime dateTime) => advanced.GetMetadataFor(obj)["@expires"] = dateTime;

        public static void RemoveExpire<T>(this IAsyncAdvancedSessionOperations advanced, T obj) => advanced.GetMetadataFor(obj).Remove("Raven-Expiration-Date");
